...
public class TopsActivity extends AppCompatActivity {
    ...
    //Initialisation
    private int TOPS_LIMIT_NBR = 50; //Maximum number of created tops in the app
    ...
    TopsFragment newTopsFragment;

    /**
     * @author Amélie Dieudonné
     * @param savedInstanceState Previous state of the activity
     * Called once when the activity is created (every time the TopsActivity is open)
     */
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            newTopsFragment = new TopsFragment();
            android.support.v4.app.FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
            ft.add(R.id.RLfragment, newTopsFragment).commit();
        }
        ...
        TextView TVnbrTops = findViewById(R.id.TVnbrTops);
        int nbrTops = Tops.getNbrTops();
        TVnbrTops.setText(""+nbrTops);

        TopsFragment.ActivityView = findViewById(android.R.id.content);
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Tops.getNbrTops()< TOPS_LIMIT_NBR){

                    //Open alert dialog
                    openAlertDialog();

                } else {
                    //If there are too many tops
                    Toast.makeText(TopsActivity.this, R.string.too_many_tops_msg, Toast.LENGTH_SHORT).show();
                }
    ...
    /**
     * @author Amélie Dieudonné
     * Open an alert dialog to add new tops
     */
    public void openAlertDialog(){

        //Initialise the alert dialog
        final AlertDialog.Builder mBuilder = new AlertDialog.Builder(TopsActivity.this);
        LayoutInflater inflater = (TopsActivity.this).getLayoutInflater();
        View mView = inflater.inflate(R.layout.popup_activity_tops, null);

        //Initialise the elements
        flipper = mView.findViewById(R.id.viewFlipper);

        ImageButton mTshirt = mView.findViewById(R.id.tshirt);
        ImageButton mShirt = mView.findViewById(R.id.shirt);
        ImageButton mSweatshirt = mView.findViewById(R.id.sweatshirt);
        ImageButton mTanktop = mView.findViewById(R.id.tanktop);
        ImageButton mPullover = mView.findViewById(R.id.pullover);
        ImageButton mDress = mView.findViewById(R.id.dress);
        HashMap<ImageButton, DressingActivity.Type> hmp_tops = new HashMap<>();
        hmp_tops.put(mTshirt, DressingActivity.Type.TSHIRT);
        hmp_tops.put(mShirt, DressingActivity.Type.SHIRT);
        hmp_tops.put(mSweatshirt, DressingActivity.Type.SWEATSHIRT);
        hmp_tops.put(mTanktop, DressingActivity.Type.TANKTOP);
        hmp_tops.put(mPullover, DressingActivity.Type.PULLOVER);
        hmp_tops.put(mDress, DressingActivity.Type.DRESS);
        ...
        mOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (hasSelectedColor && kind_cloth != null && type_cloth != null) {
                    ...
                    Toast.makeText(TopsActivity.this, R.string.success_add_msg, Toast.LENGTH_SHORT).show();

                    //add the cloth
                    new Tops(type_cloth, color_cloth, kind_cloth);

                    //refresh the fragment
                    android.support.v4.app.FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
                    ft.detach(newTopsFragment).attach(newTopsFragment).commit();
                    ...
                    Toast.makeText(TopsActivity.this, R.string.error_add_msg, Toast.LENGTH_SHORT).show();
                }
            }
        });
     ...
     * Get the type of the tops the user want to create and stock it into the global variable type_cloth
     */
                ...
                public void onClick(View view) {
                    ...
                    for (ImageButton btn_img : hmap.keySet()){
                        ...
                        if (view==btn_img){
                            ...
                            btn_img.setBackgroundTintList(ContextCompat.getColorStateList(TopsActivity.this, R.color.red));
                            for(ImageButton btn_NS : btn_not_selected.keySet()){
                                btn_NS.setBackgroundTintList(ContextCompat.getColorStateList(TopsActivity.this, R.color.btnDefault));
                            }
                        }
                    }
                }
     ...
     * Get the color of the tops the user want to create and stock it into the global variable color_cloth
     */
    ...
    /**
     * @author Amélie Dieudonné
     * @param list list of the 3 buttons specifying the kind of tops (CASUAL, CHIC or SPORT)
     * Get the kind of the tops the user want to create and stock it into the global variable kind_cloth
     */
        ...
        for (final Button btn : list) {
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    selectedButton.setBackgroundTintList(ContextCompat.getColorStateList(TopsActivity.this, R.color.red));
                    selectedButton.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.white));
                    notSelectedButton1.setBackgroundTintList(ContextCompat.getColorStateList(TopsActivity.this, R.color.btnDefault));
                    notSelectedButton1.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.black));
                    notSelectedButton2.setBackgroundTintList(ContextCompat.getColorStateList(TopsActivity.this, R.color.btnDefault));
